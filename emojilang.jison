...
DecimalLiteral ({DecimalIntegerLiteral}\.{DecimalDigits}*{ExponentPart}?)|(\.{DecimalDigits}{ExponentPart}?)|({DecimalIntegerLiteral}{ExponentPart}?) // TODO: integrate emoji numbers
LineContinuation \\(\r\n|\r|\n)
...
"💔"                              parser.restricted = true; return "BREAK";
"💼"                             return "CASE";
"🎣"                            return "CATCH";
"🤘"                         parser.restricted = true; return "CONTINUE";
"🐛"                         return "DEBUGGER";
"🙂"                          return "DEFAULT";
"🗑️"                           return "DELETE";
"🏩"                               return "DO";
...
"🎊"                               return "IN";
"💕"                       return "INSTANCEOF";
"🆕"                              parser.restricted = false; return "NEW";
"↩️"                           parser.restricted = true; return "RETURN";
"🎚️"                           return "SWITCH";
"👇"                             parser.restricted = false; return "THIS";
"⚾"                            parser.restricted = true; return "THROW";
"🍷"                              return "TRY";
"🔣"                           parser.restricted = false; return "TYPEOF";
"🎛️"                              return "VAR";
"🕳"                             parser.restricted = false; return "VOID";
"🔁"                            return "WHILE";
"👊"                             return "WITH";
"✔️"                             parser.restricted = false; return "TRUE";
"❌"                            parser.restricted = false; return "FALSE";
"🗅"                             parser.restricted = false; return "NULL";
"🏫"                            return "CLASS";
"🗿"                            return "CONST";
"📇"                             return "ENUM";
"📤"                           return "EXPORT";
...
"🙌👉"                               return "^=";
"🙌"                                return "^";
//"📣"                               parser.restricted = false; return "IDENTIFIER";
{Emoji}                             parser.restricted = false; return "IDENTIFIER";
//"~"                                parser.restricted = false; return "~";
<<EOF>>                            return "EOF";
.                                  return "ERROR";
...
var macroMap = require("./macroMap.json");
...
function IdentifierNode(name, loc) {
    ...
    this.name = name;
    if (macroMap.identifiers[this.name]) {
        this.name = macroMap.identifiers[this.name];
